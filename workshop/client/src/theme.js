...
export function createAppTheme(presetKey = ACTIVE_THEME_PRESET) {
    const palette = THEME_PRESETS[presetKey] || THEME_PRESETS[ACTIVE_THEME_PRESET] || THEME_PRESETS.monochromeSlate;
...
const theme = createAppTheme(ACTIVE_THEME_PRESET);
