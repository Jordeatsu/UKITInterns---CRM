    ...
    <Box sx={{ p: 4 }}>
      ...
      <Paper elevation={0} sx={{ borderRadius: 3, border: '1px solid rgba(0,0,0,0.07)', overflow: 'hidden' }}>
        <Box sx={{ px: 3, py: 2.5, borderBottom: '1px solid rgba(0,0,0,0.07)' }}>
          <Typography variant="h6" fontWeight={600}>All Cases</Typography>
        </Box>
              ...
              <TableBody>
                {cases.map(c => (
                  <TableRow
                    ...
                    sx={{ '&:hover': { bgcolor: '#F0F4FF' }, cursor: 'pointer', transition: 'background 0.1s' }}
                  >
                    <TableCell sx={{ fontFamily: 'monospace', fontSize: '0.78rem', color: '#1565C0', fontWeight: 600 }}>
                      {c.reference_number}
                    </TableCell>
                    <TableCell sx={{ maxWidth: 180 }}>
                      <Typography variant="body2" fontWeight={600} noWrap>{c.contact_name}</Typography>
                      <Typography variant="caption" color="text.secondary" noWrap sx={{ display: 'block' }}>{c.contact_email}</Typography>
                    </TableCell>
                    ...
                    <TableCell>
                      <Typography variant="body2" color="text.secondary">{formatDate(c.created_at)}</Typography>
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
