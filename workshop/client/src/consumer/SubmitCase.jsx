  ...
  return (
    <Box>
      ...
      <Box
        sx={{
          backgroundImage: [
            'radial-gradient(ellipse 120% 80% at 80% 50%, rgba(25,118,210,0.45) 0%, transparent 70%)',
            'linear-gradient(135deg, #0A1F4E 0%, #0D47A1 55%, #1565C0 100%)',
          ].join(', '),
          borderRadius: 3,
          px: { xs: 3, sm: 5 },
          py: { xs: 4, sm: 5 },
        ...
        <Box sx={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 3 }}>
          ...
          <Box>
            ...
            <Typography variant="body1" sx={{ opacity: 0.8, maxWidth: 480 }}>
              Fill in the form below and one of our advisors will be in touch shortly.
              You will receive a reference number to track your case.
            </Typography>
          </Box>
        </Box>
      </Box>
        ...
        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ p: { xs: 3, sm: 5 } }}>
            ...
            <Grid container spacing={2.5}>
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  ...
                  helperText={errors.product_id || 'Which product is this about?'}
                  required
                >
                  {products.map(p => (
              ...
              <Grid size={{ xs: 12, sm: 6 }}>
                <TextField
                  ...
                  helperText={errors.complaint_type_id}
                  required
                >
          ...
          <StepSection number="3" icon={<DescriptionIcon />} title="Describe Your Issue">
            <TextField
              ...
              helperText={
                errors.description ||
                'Include model number, when it happened, steps to reproduce, etc.'
              }
              multiline
              minRows={5}
              required
