                ...
                <Box sx={{ position: "relative", display: "flex", alignItems: "center", gap: 3 }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="body1" sx={{ opacity: 0.8, maxWidth: 480 }}>
                            Fill in the form below and one of our advisors will be in touch shortly. You will receive a reference number to track your case.
                        </Typography>
                    </Box>
                </Box>
            </Box>
            ...
            >
                ...
                <Box component="form" onSubmit={handleSubmit} noValidate sx={{ p: { xs: 3, sm: 5 } }}>
                    ...
                    <StepSection number="3" icon={<DescriptionIcon />} title="Describe Your Issue">
                        <TextField label="Tell us what happened" name="description" value={form.description} onChange={handleChange} error={!!errors.description} helperText={errors.description || "Include model number, when it happened, steps to reproduce, etc."} multiline minRows={5} required />
                    </StepSection>
