  ...
  if (!state?.referenceNumber) {
    return (
      <Box textAlign="center" py={8}>
        <Typography variant="h6" gutterBottom>No case found.</Typography>
        <Button variant="contained" component={Link} to="/submit">Submit a Case</Button>
      </Box>
    );
  }
      ...
      <Paper elevation={3} sx={{ overflow: 'hidden' }}>
        ...
        >
          ...
          <Typography variant="body1" sx={{ opacity: 0.85, maxWidth: 460, mx: 'auto' }}>
            Thank you for getting in touch. Your case has been logged and a member of our
